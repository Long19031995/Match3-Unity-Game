...
public class BoardController : MonoBehaviour
{
    ...
    public void StartGame(GameManager gameManager, GameSettings gameSettings, ItemSettings itemSettings)
    {
        ...
        m_board = new Board(this.transform, gameSettings, itemSettings);
